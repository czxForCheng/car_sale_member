<template>
  <div class="hole">
    <Header></Header>
    <div class="safe"/>
    <van-tabs v-model="active" background="#fff" color="#fff" title-active-color="#333" title-inactive-color="#c6c6c6" ellipsis sticky>

      <van-tab :title="$t('h.w006')">
      ...
      <van-tab title="Withdrawal history">
        <div class="card-box">
